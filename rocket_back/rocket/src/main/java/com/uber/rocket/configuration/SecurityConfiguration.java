...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers(HttpMethod.PUT, "/api/user/**").hasAnyAuthority(RoleType.CLIENT.name(), RoleType.DRIVER.name(), RoleType.ADMINISTRATOR.name());
        ...
        http.authorizeRequests().antMatchers(HttpMethod.GET, "/api/vehicle/**").permitAll();//hasAnyAuthority(RoleType.ADMINISTRATOR.name(), RoleType.DRIVER.name());
        http.authorizeRequests().antMatchers(HttpMethod.GET, "/api/vehicle/get-all").permitAll();
        http.authorizeRequests().antMatchers(HttpMethod.POST, "/api/vehicle").permitAll();
        http.authorizeRequests().antMatchers(HttpMethod.GET, "/api/ride/**").permitAll();
        http.authorizeRequests().antMatchers(HttpMethod.PUT, "/api/ride/**").permitAll();
        http.authorizeRequests().antMatchers(HttpMethod.POST, "/api/ride/**").permitAll();
